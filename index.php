...
$id = $_GET['id'];
$sql = "DELETE FROM tbl_khasnastok WHERE id_barang='$id'";
...
$id = $_GET['id'];
$sql = "SELECT * FROM tbl_khasnastok WHERE id_barang='$id'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE tbl_khasnastok SET nama_barang='$nama_barang', stok='$stok', harga_beli='$harga_beli', harga_jual='$harga_jual' WHERE id_barang='$id'";
...
<body>
    <h2>Selamat Datang di toko swalayan khasna</h2>
